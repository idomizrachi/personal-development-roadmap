...
## 📌 Current State
I'm a senior software engineer with deep knowledge in:
- **iOS Development**
- **General Software Development** (Backend focus)
...
#### iOS
- [ ] **SwiftUI**: Since more of my knowledge is in UIKit, I want to close this gap and be able to build iOS apps with SwiftUI.
